...
// Ideas Database (76 ideas curadas)
const ideasDatabase = [
  ...
  { author: "Bertrand Russell", quote: "The good life is inspired by love and guided by knowledge", primaryTag: "VIRTUE & CHARACTER", secondaryTag: "wisdom" },
  { author: "Bertrand Russell", quote: "Three passions have ruled my life: the desire to love, the search for knowledge, and unbearable pity for the suffering of mankind", primaryTag: "VIRTUE & CHARACTER", secondaryTag: "wisdom" },
  { author: "Peter Singer", quote: "The capacity for suffering is a prerequisite for having interests. If a being suffers, there can be no moral justification for disregarding that suffering", primaryTag: "SUFFERING & MENTAL STATES", secondaryTag: "ethics" },
  { author: "Voltaire", quote: "Perfect is the enemy of good", primaryTag: "VIRTUE & CHARACTER", secondaryTag: "wisdom" },
  { author: "Aristotle", quote: "Virtue is a habit, a settled disposition to act in certain ways", primaryTag: "VIRTUE & CHARACTER", secondaryTag: "example" },
  { author: "Aristotle", quote: "The golden mean lies between extremes", primaryTag: "VIRTUE & CHARACTER", secondaryTag: "moderation" },
  { author: "Marcus Aurelius", quote: "You have power over your mind - not outside events. Realize this, and you will find strength", primaryTag: "SUFFERING & MENTAL STATES", secondaryTag: "control" },
  { author: "Epictetus", quote: "Some things are in your control, and some things are not in your control", primaryTag: "SUFFERING & MENTAL STATES", secondaryTag: "control" },
  { author: "Zhuangzi", quote: "When you have nothing left to desire, everything becomes possible", primaryTag: "MATERIAL LIFE & NEEDS", secondaryTag: "simplicity" },
];

// Fragmentos de Cartas/Emails 1-13 como fuentes adicionales para el Buzón
const cartasEmailsFragments = [
  { source: "Carta 1", excerpt: "El tiempo es lo único que tenemos, pero lo desperdiciamos en distracciones y reuniones innecesarias. Mi tiempo real de vida ha sido no más de 5 años de los 45 que tengo.", tags: "TIME & MORTALITY" },
  { source: "Email 1", excerpt: "Tu atención, Lucilio, es lo que da valor al tiempo. De ahí que cada momento sea distinto, irrepetible. El tiempo es lo único que tenemos, pero lo desperdiciamos constantemente.", tags: "TIME & MORTALITY" },
  { source: "Carta 2", excerpt: "Leer es ser. Cada idea es un ladrillo de la mejor construcción. Leo con regular variedad según mis necesidades, no por disciplina, sino porque necesito resolver situaciones distintas.", tags: "FOCUS & LEARNING" },
  { source: "Email 2", excerpt: "Coherencia en la multiplicidad: las conexiones entre ideas es lo que importa realmente. Un libro, una conversación, una experiencia vivida, todo es alimento para el espíritu atento.", tags: "FOCUS & LEARNING" },
  { source: "Carta 3", excerpt: "La amistad verdadera, como el amor, comienza con uno mismo. Ser amigo de otro por no poder bastarse a sí mismo no es amistad, es conveniencia. Necesitamos amigos similares y completamente distintos.", tags: "RELATIONSHIPS & SOLITUDE" },
  { source: "Email 3", excerpt: "En la amistad se siente una rara armonía. Elegimos amigos no por conveniencia, sino porque verdaderamente queremos serlo. La reciprocidad es bienvenida, pero no es lo importante.", tags: "RELATIONSHIPS & SOLITUDE" },
  { source: "Carta 4", excerpt: "Estoy muriendo todos los días. Mi vida puede terminar en cualquier momento. He decidido aprovechar al máximo cada momento que me queda, sin esperar al futuro.", tags: "TIME & MORTALITY" },
  { source: "Email 4", excerpt: "No debes temer a la muerte misma, sino a perder lo que tienes: tu capacidad de atención, de vivir plenamente. Los que posponen vivir hasta que la muerte los alcance son los verdaderos muertos en vida.", tags: "TIME & MORTALITY" },
  { source: "Carta 5", excerpt: "Ser diferente no significa vivir en extremos. La soledad extrema es aislamiento, no filosofía. Reconozco que puedo estar completamente equivocado en mis creencias sobre lo divino.", tags: "RELATIONSHIPS & SOLITUDE" },
  { source: "Email 5", excerpt: "Sé el fotógrafo, no el protagonista de la película. Observa tu vida como si fuera la de otro, pero vívela como si fuera la tuya. La filosofía no es teoría; es práctica.", tags: "FOCUS & LEARNING" },
  { source: "Carta 6", excerpt: "El conocimiento sin compartir permanece incorrecto. Se convierte en sabiduría cuando se comparte con otros. Estoy empezando a conocer otras grandes mentes que me quiero guiar: Singer, Russell, Voltaire.", tags: "RELATIONSHIPS & SOLITUDE" },
  { source: "Email 6", excerpt: "Acción con reflexión. Es la acción la que marca la nueva dirección, no la conversación. El verdadero maestro no es quien más sabe, sino quien mejor comunica lo que sabe.", tags: "FOCUS & LEARNING" },
  ...
  { source: "Email 7", excerpt: "Solo quien se ha encontrado consigo mismo puede realmente encontrarse con los demás. Pues al final, somos el mismo. Estar solo por convicción debería ser tan importante como el sueño.", tags: "RELATIONSHIPS & SOLITUDE" },
  { source: "Carta 8", excerpt: "No es que simplemente me retire del trabajo actual, sino que me quiero dedicar a otros trabajos mejores para mí, para nosotros, para ellos, para todos. El ciclo de leer-escribir-aplicar-compartir podría ser la fórmula perfecta.", tags: "FOCUS & LEARNING" },
  { source: "Email 8", excerpt: "Son cinco los niveles de comunión: multitudes, reuniones grupales, conversaciones uno a uno, solitud reflexiva, y el nivel más profundo de unidad. Todos son necesarios, y el sabio guarda tiempo apropiado para cada nivel.", tags: "RELATIONSHIPS & SOLITUDE" },
  { source: "Carta 9", excerpt: "No necesito tener amigos, pero sí quiero tenerlos. La verdadera amistad no es algo que se busca, sino se fabrica, se cultiva, se invierte en ella. Practicar amistad con uno mismo es el mejor ejercicio para practicarla con otros.", tags: "RELATIONSHIPS & SOLITUDE" },
  { source: "Email 9", excerpt: "Del amigo, mucho está dicho, pero muy poco del lazo que los conecta. La amistad exige disposición real y voluntad de practicar la virtud en su forma más pura. Debes ser amigo de quienes necesitan crecer.", tags: "RELATIONSHIPS & SOLITUDE" },
  { source: "Carta 10", excerpt: "Mi creencia en el todo no tiene probabilidades despreciables de ser cierta. He decidido vivir de manera que no necesito creer en un dios para conducirme bien. Para mí, vivir con amor, buscar conocimiento y aliviar sufrimiento define una buena vida.", tags: "VIRTUE & CHARACTER" },
  { source: "Email 10", excerpt: "La soledad y la compañía no son opuestas, sino complementarias. La soledad es la base; la interacción el exponente. Si comparto lo que tengo y otros lo suyo, juntos podemos producir lo que un Dios podría producir.", tags: "RELATIONSHIPS & SOLITUDE" },
  { source: "Carta 11", excerpt: "Los defectos no se pueden eliminar, solo moderar. La verdadera sabiduría no se trata de eliminar nada, sino de gestionarlo. Mis hijas siempre están viendo aunque no estén mirando todo lo que hago, y eso me hace mejor.", tags: "VIRTUE & CHARACTER" },
  { source: "Email 11", excerpt: "La moderación debe ser siempre un referente, no porque te represente, sino porque contiene lo esencial de una vida bien vivida. Construye un gran referente a partir de las virtudes de muchos. Cultiva el gusto por los extremos cuando de ideas se trata.", tags: "VIRTUE & CHARACTER" },
  { source: "Carta 12", excerpt: "Estoy realmente viviendo. Me siento más productivo, más tranquilo, más motivado. Tan completo me parece este día que contiene casi todo lo que pediría si fueran mis últimas horas. Aunque sigue siendo la semana mi unidad preferida, intento aprovechar cada día al máximo.", tags: "TIME & MORTALITY" },
  { source: "Email 12", excerpt: "La vejez es como una biblioteca. El kairos sobre el kronos: no son los años transcurridos los que generan sabiduría, sino los días realmente vividos. De joven la mente sirve al cuerpo; de viejo es el cuerpo quien debe aprender a servir a la mente.", tags: "TIME & MORTALITY" },
  { source: "Carta 13", excerpt: "He sufrido antes de lo necesario, o más de lo necesario, sin saber si era necesario. La mente está programada para predecir futuros. Pero para situaciones nuevas no tenemos capacidad de predicción. Sufrir por lo que no ha llegado es estupidez de la imaginación.", tags: "SUFFERING & MENTAL STATES" },
  { source: "Email 13", excerpt: "Si algún sufrimiento necesario existe, debe ser aquel que elegiste padecer voluntariamente. En este caso no lo padecerás sino agradecerás, porque habrá sido para conseguir algo más importante. Lo realmente importante nunca puede ser sólo para uno mismo.", tags: "SUFFERING & MENTAL STATES" },
];
